        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-8">
                <input type="text" value="{{ old('name', $student->name) }}" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Nama Mahasiswa">
                @error('name')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-8">
                <input type="text" value="{{ old('nim', $student->nim) }}" class="form-control @error('nim') is-invalid @enderror" id="nim" name="nim" placeholder="Nomor Induk Mahasiswa" disabled>
                @error('nim')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <input type="number" step="0.01" value="{{ old('ipk', $student->ipk) }}" class="form-control @error('ipk') is-invalid @enderror" id="ipk" name="ipk" min="0" max="4" placeholder="contoh: 3.15">
              @error('ipk')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="mb-3">
              ...
              <input type="number" step="0.01" value="{{ old('ips', $student->ips) }}" class="form-control @error('ips') is-invalid @enderror" id="ips" name="ips" min="0" max="4" placeholder="contoh: 3.96">
              @error('ips')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
